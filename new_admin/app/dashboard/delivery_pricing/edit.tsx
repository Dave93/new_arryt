...
interface DeliveryPricingEditProps {
  id: string;
}

export default function DeliveryPricingEdit({ id }: DeliveryPricingEditProps) {
  ...
  return (
    <div className="space-y-6">
      <PageTitle title="Редактировать условие доставки" />
