...
export const CouriersController = new Elysia({
    name: "@app/couriers",
  })
    .use(contextWitUser)
  ...
  .get('/api/couriers/roll_call/:id', async ({ params: { id }, query: { startDate, endDate }, drizzle, user, set }) => {
  ...
  .get("/api/couriers/all", async ({ drizzle, user, set }) => {
    const { password, ...fields } = getTableColumns(users);
    const couriersList = await drizzle
      .select(fields)
      .from(users)
  ...
  .get(
    "/api/couriers/my_unread_notifications",
  ...
  .get('/api/couriers/for_terminal', async ({ query: { terminal_id }, drizzle, user, set }) => {
  ...
  .get('/api/couriers/my_profile_number', async ({ drizzle, user, set }) => {
  ...
  .get('/api/couriers/mob_stat', async ({ drizzle, user, set, redis, cacheControl }) => {
  ...
  .get('/api/couriers/my_couriers/balance', async ({ user, drizzle, set }) => {
  ...
  .get('/api/couriers/locations', async ({ user, redis }) => {
  ...
  .get('/api/couriers/:id/:terminal_id/balance', async ({ user, drizzle, set, params: { id, terminal_id } }) => {
  ...
  .post('/api/couriers/efficiency', async ({ body: { startDate, endDate, courier_id, terminal_id, status }, drizzle, user, set, cacheControl }) => {

    const query = await drizzle.execute<{
      courier_id: string;
      terminal_id: string;
      hour_period: string;
  ...
  .post('/api/couriers/efficiency/hour', async ({ body: { startDate, endDate, courierId }, drizzle, user, set }) => {
  ...
  .post('/api/couriers/efficiency/period', async ({ body: { startDate, endDate, courierId }, drizzle, user, set }) => {
  ...
  .post('/api/couriers/store-location', async ({ body: { lat, lon, app_version }, drizzle, user, set, queues: {
